webpackHotUpdate("static\\development\\pages\\provider\\home.js",{
...
/* harmony import */ var _less_InnerNav_less__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./less/InnerNav.less */ "./components/shared/less/InnerNav.less");
/* harmony import */ var _less_InnerNav_less__WEBPACK_IMPORTED_MODULE_11___default = /*#__PURE__*/__webpack_require__.n(_less_InnerNav_less__WEBPACK_IMPORTED_MODULE_11__);
/* harmony import */ var _Display__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./Display */ "./components/shared/Display.js");
...
function (_Component) {
  ...
  function InnerNav() {
      ...
      return _this.state.links.map(function (link, i) {
        return react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(next_link__WEBPACK_IMPORTED_MODULE_10___default.a, {
          ...
          onClick: function onClick() {
            return _this.handleItemClick(link.text);
          }
        }, react__WEBPACK_IMPORTED_MODULE_7___default.a.createElement(_Display__WEBPACK_IMPORTED_MODULE_12__["default"], {
          if: link.hasNotif
    ...
    Object(_babel_runtime_corejs2_helpers_esm_defineProperty__WEBPACK_IMPORTED_MODULE_6__["default"])(Object(_babel_runtime_corejs2_helpers_esm_assertThisInitialized__WEBPACK_IMPORTED_MODULE_4__["default"])(_this), "handleItemClick", function (name) {
      _this.setState({
        activeItem: name
      });
    });
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(InnerNav, [{
    ...
    value: function componentDidMount() {
      this.setState({
        activeItem: this.state.links.find(function (link) {
          return link.to === next_router__WEBPACK_IMPORTED_MODULE_9___default.a.router.route;
        }).text
      });
    }
  }, {
...
//# sourceMappingURL=home.js.df940c93b96879419976.hot-update.js.map