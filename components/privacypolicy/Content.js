...
const Content = () => {
  return (
    <Container className="privacypolicy" style={styles.Container}>
Introduction <br />
<p>
  Welcome to the Glamour On Demand[COMPANY]'s privacy policy. 
Glamour On Demand [COMPANY] respects your privacy and is committed to protecting your personal data. This privacy policy will inform you as to how we look after your personal data when you visit our website (regardless of where you visit it from) and tell you about your privacy rights and how the law protects you. 
This privacy policy is provided in a layered format so you can click through to the specific areas set out below. [Alternatively, you can download a pdf version of the policy here: [LINK].] Please also use the Glossary to understand the meaning of some of the terms used in this privacy policy. </p>
<ol>
...
<p>This privacy policy aims to give you information on how Glamour On Demand [COMPANY] collects and processes your personal data through your use of this website, including any data you may provide through this website when you [sign up to our newsletter OR purchase a product or service OR take part in a competition. OR [OTHER EXAMPLE]]. 
This website is not intended for children and we do not knowingly collect data relating to children.
It is important that you read this privacy policy together with any other privacy policy or fair processing policy we may provide on specific occasions when we are collecting or processing personal data about you so that you are fully aware of how and why we are using your data. This privacy policy supplements other notices and privacy policies and is not intended to override them. 
Controller </p>
<p>Glamour On Demand Limited[IF ONLY ONE ENTITY:] [LEGAL ENTITY NAME] is the controller and responsible for your personal data (collectively referred to as ["COMPANY"], "we", "us" or "our" in this privacy policy).
[IF SEVERAL ENTITIES PART OF A GROUP:] [COMPANY] is made up of different legal entities, details of which can be found here: [LINK]. This privacy policy is issued on behalf of the [COMPANY] Group so when we mention ["COMPANY"], "we", "us" or "our" in this privacy policy, we are referring to the relevant company in the [COMPANY] Group responsible for processing your data. [We will let you know which entity will be the controller for your data when you purchase a product or service with us.] [LEGAL ENTITY NAME] is the controller and responsible for this website. 
...
Full name of legal entity: Glamour On Demand Limited[DETAILS] <br />
Email address: info@glamourondemand.com[DETAILS] <br />
Postal address: 2 Plane Street, Sydenham, London, SE26 6JU[DETAILS] <br />
[Telephone number: [DETAILS]] <br />
...
Changes to the privacy policy and your duty to inform us of changes </p>
<p>We keep our privacy policy under regular review. T[This version was last updated on 07/05/19[DATE]. [Historic versions [are archived here: [LINK] OR can be obtained by contacting us]].] 
...
<p>Transaction Data includes [details about payments to and from you and other details of products and services you have purchased from us].
...
If you fail to provide personal data </p>
...
Direct interactions. You may give us your [Identity, Contact and Financial Data] by filling in forms or by corresponding with us by post, phone, emailand email or otherwise. This includes personal data you provide when you [DELETE OR ADD TO THIS LIST AS APPROPRIATE]: <br />
...
Identity and Contact Data from publicly available sources [such as Companies House and the Electoral Register based inside the EU]. <br />
...
To enable you to partake in a prize draw, competition or complete a survey<br />
(a) Identity <br />
(b) Contact <br />
(c) Profile <br />
(d) Usage <br />
...
Professional advisers [acting as processors or joint controllers] including lawyers, bankers, auditors and insurers based in the United Kingdom[SPECIFIC COUNTRIES] who provide [consultancy, banking, legal, insurance and accounting services].
