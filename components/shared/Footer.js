          ...
          <Grid.Row>
            ...
            <Grid.Column width="4">
              <List link>
                ...
                <Link href="/">
                  <List.Item as="a">Hair</List.Item>
                </Link>
                <Link href="/">
                  <List.Item as="a">Hair removal</List.Item>
                </Link>
                <Link href="/">
                  <List.Item as="a">Massage</List.Item>
                </Link>
                <Link href="/">
                  <List.Item as="a">Nails</List.Item>
                </Link>
                <Link href="/">
                  <List.Item as="a">Face</List.Item>
                </Link>
                <Link href="/">
                  <List.Item as="a">Body</List.Item>
                </Link>
              </List>
            </Grid.Column>
            <Grid.Column width="4">
              ...
              <List className="social-links" horizontal relaxed>
                <List.Item>
                  <a
                    href="https://www.instagram.com/groomingondemandltd/"
                    style={{ color: 'white' }}
                  >
        ...
        <Grid>
          <Grid.Row className="cookie">
            <Grid.Column largeScreen={14} mobile={16}>
              ...
              We use cookies to personalise and provide certain functionalities
              across the Urban website. They also help us analyse how people use
              our site and help us improve it. By continuing to use this site
              you are agreeing to use our cookies as defined in our{' '}
